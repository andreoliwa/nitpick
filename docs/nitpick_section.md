# The \[nitpick\] table {#nitpick_section}

The \[nitpick\] table in [the style file](styles.md) contains global settings for the style.
...
Example of usage: [Nitpick's default style](https://github.com/andreoliwa/nitpick/blob/master/nitpick-style.toml).
...
Relative references are resolved relative to the URI of the style doument they are included in according to the [normal rules of RFC 3986](https://www.rfc-editor.org/rfc/rfc3986.html#section-5.2).
