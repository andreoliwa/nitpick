...
You will see warnings if your project configuration is different than [the default style file](https://raw.githubusercontent.com/andreoliwa/flake8-nitpick/v0.11.0/nitpick-style.toml).
...
Change your project config on `pyproject.toml`, and configure your own style like this:
    ...
    [tool.nitpick]
    style = "https://raw.githubusercontent.com/andreoliwa/flake8-nitpick/v0.11.0/nitpick-style.toml"
...
3. If no style is found, then [the default style file from GitHub](https://raw.githubusercontent.com/andreoliwa/flake8-nitpick/v0.11.0/nitpick-style.toml) is used.
